...
// "VOTING_ID", "USER_ID" }, name = "UK_VOTING_USER"))
public class VoteUser extends BaseModel {
	...
	@JoinColumn(name = "GROUP_ID", foreignKey = @ForeignKey(name = "FK_GROUPS_VOTES_USERS"))
	private Group group;

	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "USER_ID", foreignKey = @ForeignKey(name = "FK_USERS_VOTES_USERS"))
	private User user;
